...
/// 次操作ガイド（<see cref="NestSuiteShellWindow.GettingStartedHint"/>）の
...
{
    /// <summary>
    /// 起動時に一度だけ、recent files上位3件と保持中draft件数をTempNestへ渡す。
    ...
    /// <summary>recentリンククリック時にファイル不存在等で一覧から削除された項目をパネルからも取り除く。</summary>
    ...
    /// <summary>通常タブ追加時に「続きから」を再表示しないようにする単発ラッチを立てる。</summary>
