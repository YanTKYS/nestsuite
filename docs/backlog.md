...
SH-15 は v2.16.3、SH-19 は v2.16.4、SH-28 は v2.16.5 で実装済み（欠番）。詳細は `docs/release-notes.md` 参照。
...
TD-1〜TD-58、TD-60〜TD-62、TD-64 は完了済み（欠番）。詳細は `docs/release-notes.md` 参照。
