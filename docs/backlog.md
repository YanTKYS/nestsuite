...
SH-1 は v2.16.11、SH-15 は v2.16.3、SH-19 は v2.16.4、SH-28 は v2.16.5、SH-29 は v2.16.9、SH-30 は v2.16.10、SH-34 は v2.16.21、SH-37 は v2.18.3、SH-38 は v2.18.5、SH-39 は v2.18.15、SH-40（AT-1 フェーズ1）は v2.18.17、SH-41（AT-2 フェーズ1）は v2.18.18 で実装済み（欠番）。詳細は `docs/release-notes.md` 参照。
