...
| 文書 | 対象バージョン | 状態 |
|------|--------------|------|
| `notenest-editor-textbox-dependencies.md` | v2.5.1 (H0-1) | v2.5.x で実装完了 |
| `notenest-editor-adapter-design.md` | v2.5.2 (H0-2) | v2.5.x で実装完了 |
| `notenest-editor-host-design.md` | v2.5.4 (H0-4) | v2.5.x で実装完了 |
| `notenest-editor-h0-reassessment.md` | v2.5.5 (H0-5) | v2.5.x で実装完了 |
